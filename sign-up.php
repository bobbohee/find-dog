...
<section class="section-log">
  <div class="sign sign-up">
    ...
    <form action="sign-up-ok.php" method="post">
      ...
      <input type="password" name="userpw" id="userpw" class="form-control" autocomplete=off required>
      <label for="usermail" class="control-label control-label-mail">이메일 </label>    
      <input type="email" name="useremail" id="usermail" class="form-control" autocomplete=off required>
